...
namespace Infrastructure.Data.ConfigurationsEntity.LoyaltyProgramSpace.Loyalty
{
    ...
    /// </summary>
    public class LoyaltyTierConf : TranslatableEntityConf<LoyaltyTierTranslation, LoyaltyTier> 
    {
        public LoyaltyTierConf(ModelBuilder modelBuilder) : base(modelBuilder)
        {
