...
{ 
    ...
    /// </summary>
    public class LoyaltyProgramConf : SeoTranslatableEntityConf<LoyaltyProgramTranslation, LoyaltyProgram>
    {
        public LoyaltyProgramConf(ModelBuilder modelBuilder) : base(modelBuilder) 
        {
