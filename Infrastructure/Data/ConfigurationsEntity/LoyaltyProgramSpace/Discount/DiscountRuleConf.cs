...
namespace Infrastructure.Data.ConfigurationsEntity.LoyaltyProgramSpace.Discount
{
    ...
    /// </summary>
    public class DiscountRuleConf : TranslatableEntityConf<DiscountRuleTranslation, DiscountRule>
    {
        public DiscountRuleConf(ModelBuilder modelBuilder): base(modelBuilder) 
        {
