...
namespace _26_01_25.Entities._Category
{
    /// <summary>
    /// Категория товаров в системе
    /// </summary>
    [Table("categories")]
    public class Category : TranslatableEntity<CategoryTranslation, Category>
    {
        [Key]
        [Column("id")]
        ...
        {
            TranslatableEntity<CategoryTranslation, Category>.ConfigureEntity(modelBuilder);
