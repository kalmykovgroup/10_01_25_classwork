...
import {toggleFavoriteThunk} from "../../../store/productSpace/productsSlice.ts";
...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    const handleFavoriteClick = () => {
        dispatch(toggleFavoriteThunk(product.id));
    };
        ...
        <div className={styles.productCard}>
            ...
            <div className={styles.imageWrap}>
                <img
                    ...
                    alt={product.name}
                    className={`${styles.image} ${!product.url ? styles.placeholder : ""}`}
                />
            </div>
